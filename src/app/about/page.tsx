        ...
        <div className="flex w-full flex-col items-center justify-center text-red-800 bg-red-50" >
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-8 gap-4 md:gap-16 mt-10 md:mt-20">
                <div className="col-span-1  md:col-span-3 flex flex-col items-start justify-start ">
                    ...
                    Welcome! I am Asma Ali, and I know I can help your company create stunning visuals.
                     As someone who has worked in marketing and graphic design for over a decade, I know what brands need to capture their audiencess attention. With my powerful design skills and knack for marketing,
                     I have the right background for your brands needs.
                    ...
                    so you will also find my nose buried in a book or travel blog.
                    </p>


                    <p className="font-medium px-4 md:px-14 mt-1 md:mt-4">
                    When you are ready for your brand to reach its next level of success, call or email me. I have the right tools and expertise to turn your brand into a household name.
                      See it for yourself in my works section.
                    </p>
                </div>
